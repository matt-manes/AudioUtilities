...
TEST_CLASS(ClampTest)
{
  public :
    TEST_METHOD(TestClamp)
    {
        ...
        Assert::AreEqual(0.0f, AudioUtilities::Clamp::clamp(-1.0f, 1.0f, 0.0f), 0.001f);
        Assert::AreEqual(0.5f, AudioUtilities::Clamp::clamp(0.5f, 1.0f, 0.0f), 0.001f);
        Assert::AreEqual(1.0f, AudioUtilities::Clamp::clamp(1.5f, 1.0f, 0.0f), 0.001f);
    }
